...
class RobotVoiceTeleop:
    ...
    def  __init__(self):
        ...
        # Subscribe to the /move_hardware topic to receive voice commands.
        rospy.Subscriber('/move_hardware', String, self.voice_command_callback)
        ...
        rospy.loginfo("Ready to receive move hardware commands")
